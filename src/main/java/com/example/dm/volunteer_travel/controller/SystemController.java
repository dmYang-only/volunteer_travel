...
public class SystemController {
    ...
    @ResponseBody
    public Result login(SysUser sysUser, HttpServletResponse response,HttpServletRequest request) {
    ...
    @RequestMapping("/orderListUI1")
    public String orderListUI1(Model model, @PageableDefault(size = 10) Pageable pageable) {
        Page<UserHotel> page = systemService.getUserHotelPage(pageable);
        model.addAttribute("page",page);
        return "system/order/list1";
    }
    ...
    public Result deleteOrder(String id) {
        return systemService.deleteOrder(id);
    }

    @RequestMapping("/deleteOrder1")
    @ResponseBody
    public Result deleteOrder1(String id) {
        return systemService.deleteOrder1(id);
    }
