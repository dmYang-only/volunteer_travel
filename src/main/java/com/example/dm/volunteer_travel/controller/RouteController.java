...
import com.example.dm.volunteer_travel.model.UserRoute;
import com.example.dm.volunteer_travel.service.RouteService;
import com.example.dm.volunteer_travel.util.MapUtils;
...
public class RouteController {
    ...
    public String routeMap(Model model,HttpServletRequest request,@RequestParam(name = "id") String id) throws IOException {
        TravelRoute travelRoute = routeService.findTravelRouteById(id);
        String[] coordinate = MapUtils.getCoordinate(travelRoute.getName());
