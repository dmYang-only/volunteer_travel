...
public class TravelRoute {
    ...
    private List<RouteComment> routeCommentList=new ArrayList<RouteComment>();
    ...
    public List<RouteComment> getRouteCommentList() {
        return routeCommentList;
    }

    public void setRouteCommentList(List<RouteComment> routeCommentList) {
        this.routeCommentList = routeCommentList;
    }
}
